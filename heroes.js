...
const heroes = [
    ...
    },
    {
    ...
    },
     {
        ...
        description: 'Самое милое создание во вселенной! От его улыбки тают даже ледяные сердца. Всегда готов обнять, утешить и подарить тепло. Его суперсила — делать мир добрее одним своим присутствием.',
