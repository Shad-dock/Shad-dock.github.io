...
const heroes = [
    ...
    },
    {
        ...
        description: 'Таинственная и загадочная. Разбирается в зельях и магии.',
        tags: ['Магия', 'Загадочность', 'Зелья']
    },
    {
        name: 'Герц-кухарка',
        image: 'images/Герц-кухарка.jpg',
        description: 'Королева кухни! Готовит самые вкусные блюда. Её пироги — легенда!',
    ...
    },
    {
        ...
        description: 'Мечтатель и поэт. Пишет стихи о любви и дарит цветы.',
    ...
    },
    {
        ...
        description: 'Неутомимая и энергичная! Всё успевает и заряжает всех.',
