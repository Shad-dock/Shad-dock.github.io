...
function fireConfetti() {
    ...
    // Вторая порция — слева (через 150 мс)
    setTimeout(() => {
        confetti({
            particleCount: 60,
            spread: 60,
    ...
    // Третья порция — по центру (через 300 мс)
    setTimeout(() => {
        confetti({
            particleCount: 40,
            spread: 80,
...
const heroes = [
    ...
    {
        name: 'Косячный Герц',
        image: 'images/Косячный Герц.jpg',
        description: 'Самый неловкий и забавный герой во вселенной! Вечно спотыкается на ровном месте и путает имена.',
        tags: ['Неловкость', 'Юмор', 'Обаяние', 'Позитив']
    },
    {
    name: 'Стеснительный Герц',
    image: 'images/Стеснительный Герц.jpg',
    description: 'Робкий и застенчивый, но с золотым сердцем. Краснеет от каждого комплимента.',
    tags: ['Стеснительность', 'Доброта', 'Уют', 'Забота']
    },
    {
    name: 'Ищущий свободу Герц',
    image: 'images/Ищущий свободу Герц.jpg',
    description: 'Он не любит принципы, рамки и границы — его дом там, где ветер и дорога. Мечтает увидеть мир.',
    tags: ['Свобода', 'Приключения', 'Путешествия', 'Ветер']
    },
    {
    name: 'Герц-бибизян',
    image: 'images/Герц-бибизян.jpg',
    description: 'Уморительный проказник с вечным запасом бананов! Обожает кривляться, болтаться на ветках и кидаться кожурой в прохожих.',
    tags: ['Юмор', 'Ловкость', 'Бананы', 'Энергия']
    },
    {
    name: 'Герц-мухобой',
    image: 'images/Герц-мухобой.jpg',
    description: 'Грозный страж тишины и покоя! Его главная миссия — не давать назойливым мухам и комарам испортить ни один обед.',
    tags: ['Юмор', 'Ловкость', 'Бананы', 'Энергия']
    },
    {
    name: 'Lucky Герц',
    image: 'images/Lucky Герц.jpg',
    description: 'Владелец самого непредсказуемого колеса во вселенной! Однажды оно выиграло ему билет в Китай, в другой раз — банан.',
    tags: ['Удача', 'Азарт', 'Китай', 'Банан']
    }
];
